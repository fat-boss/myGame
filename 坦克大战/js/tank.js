	...
	this.move=function(){
		...
		if(this.isAI){
			...
			if(this.frame%100==0 || this.hit){
				this.dir=parseInt(Math.random()*4);//随机产生一个方向
				this.hit=false;
				this.frame=0;	
			}
		}
